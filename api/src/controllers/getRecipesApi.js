...
const { RENDER_API_KEY1} = process.env; // define the api key of recipes.
const recipesUrl = `https://api.spoonacular.com/recipes/complexSearch?apiKey=${RENDER_API_KEY1}&addRecipeInformation=true&number=20`; // endpoint for make petitions.
